# Dictionnaire de traduction français -> anglais
 = @{
    ...
    'Zones actives' = 'Active Zones'
    'Devices connectés' = 'Connected Devices'
    'Alertes 24h' = '24h Alerts'
    'Violations' = 'Violations'
    'Carte en temps réel' = 'Real-time Map'
    'Alertes récentes' = 'Recent Alerts'
    'Activité des 7 derniers jours' = '7-Day Activity'
    ...
    'Modifier la zone' = 'Edit Zone'
    'Créer une zone' = 'Create Zone'
    'Paramètres' = 'Settings'
...
Get-ChildItem -Path src -Recurse -Filter "*.jsx" | ForEach-Object {
     = .FullName
    Write-Host "Traitement de: " -ForegroundColor Cyan
...
export default ZonesListPage;
 -replace [regex]::Escape(), []
        # Version avec guillemets simples
         = "''"
        import React, { useState, useEffect } from 'react';
import {
  Box,
...
export default ZonesListPage;
 -replace [regex]::Escape(), "''"
        # Version avec guillemets doubles
         = '"' +  + '"'
        import React, { useState, useEffect } from 'react';
import {
  Box,
...
export default ZonesListPage;
 -replace [regex]::Escape(), '"' + [] + '"'
    ...
    # Supprimer tous les accents restants
    import React, { useState, useEffect } from 'react';
import {
  Box,
  Paper,
...
export default ZonesListPage;
 | Out-File -Encoding utf8 
    ...
    Write-Host "  ✓ Traduit: " -ForegroundColor Green
}

Write-Host "
Traduction terminée !" -ForegroundColor Green
Write-Host "Des fichiers de sauvegarde (.bak) ont été créés." -ForegroundColor Yellow
